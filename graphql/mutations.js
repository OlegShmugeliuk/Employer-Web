...
export const createBenefiUser = /* GraphQL */ `
  mutation CreateBenefiUser(
    $input: CreateBenefiUserInput!
    $condition: ModelBenefiUserConditionInput
  ) {
    createBenefiUser(input: $input, condition: $condition) {
      emailAddress
      Employer {
        id
        name
      ...
      createdAt
      updatedAt
      benefiUserEmployerId
    }
  }
`;
export const updateBenefiUser = /* GraphQL */ `
  mutation UpdateBenefiUser(
    $input: UpdateBenefiUserInput!
    $condition: ModelBenefiUserConditionInput
  ) {
    updateBenefiUser(input: $input, condition: $condition) {
      emailAddress
      Employer {
        id
        name
...
`;
export const deleteBenefiUser = /* GraphQL */ `
  mutation DeleteBenefiUser(
    $input: DeleteBenefiUserInput!
    $condition: ModelBenefiUserConditionInput
  ) {
    deleteBenefiUser(input: $input, condition: $condition) {
      emailAddress
      Employer {
        id
        name
