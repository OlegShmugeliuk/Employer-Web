...
export const onCreateBenefiUser = /* GraphQL */ `
  subscription OnCreateBenefiUser(
    $filter: ModelSubscriptionBenefiUserFilterInput
  ) {
    onCreateBenefiUser(filter: $filter) {
      emailAddress
      Employer {
        id
        name
...
`;
export const onUpdateBenefiUser = /* GraphQL */ `
  subscription OnUpdateBenefiUser(
    $filter: ModelSubscriptionBenefiUserFilterInput
  ) {
    onUpdateBenefiUser(filter: $filter) {
      emailAddress
      Employer {
        id
        name
...
`;
export const onDeleteBenefiUser = /* GraphQL */ `
  subscription OnDeleteBenefiUser(
    $filter: ModelSubscriptionBenefiUserFilterInput
  ) {
    onDeleteBenefiUser(filter: $filter) {
      emailAddress
      Employer {
        id
        name
