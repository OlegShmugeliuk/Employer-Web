...
export const getBenefiUser = /* GraphQL */ `
  query GetBenefiUser($emailAddress: String!) {
    getBenefiUser(emailAddress: $emailAddress) {
      emailAddress
      Employer {
        id
        name
...
`;
export const listBenefiUsers = /* GraphQL */ `
  query ListBenefiUsers(
    $emailAddress: String
    $filter: ModelBenefiUserFilterInput
    $limit: Int
    $nextToken: String
...
`;
export const userByBenefiEmployer = /* GraphQL */ `
  query UserByBenefiEmployer(
    $employerId: String!
    $sortDirection: ModelSortDirection
    $filter: ModelBenefiUserFilterInput
    $limit: Int
